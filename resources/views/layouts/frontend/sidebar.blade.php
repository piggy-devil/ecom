...
<div id="sidebar" class="span3">
    <div class="well well-small"><a id="myCart" href="product_summary.html"><img src="{{ url('frontend/themes/images/ico-cart.png') }}" alt="cart">3 Items in your cart</a></div>
    <ul id="sideManu" class="nav nav-tabs nav-stacked">
        ...
        <li class="subMenu"><a>{{ $section['name'] }}</a>
            ...
            <ul>
                ...
                <li><a href="{{ $subcategories['url'] }}"><i class="icon-chevron-right"></i>{{ $subcategories['category_name'] }}</a></li>
                @endforeach
            </ul>
            @endforeach
        </li>
    ...
    <br />
    <div class="thumbnail">
        <img src="{{ url('frontend/themes/images/payment_methods.png') }}" title="Payment Methods" alt="Payments Methods">
        <div class="caption">
